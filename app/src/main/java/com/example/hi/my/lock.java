...
public class lock extends SQLiteOpenHelper {
    ...
    public static final String CONTACTS_TABLE_NAME = "sale";
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("create table lock " + "(id integer primary key, entered text, stored text)");
    ...
    public boolean insertData(String entered) {
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues contentValues = new ContentValues();
        contentValues.put("entered", entered);
    ...
    public Cursor getData(String id) {
        SQLiteDatabase db = this.getReadableDatabase();
        Cursor res =  db.rawQuery( "select * from lock where entered ="+id+"", null );
        return res;
    }

    public Integer deleteData() {
        SQLiteDatabase db = this.getWritableDatabase();
        return db.delete("sale",null,null);
    }

    public int numberOfRows(){
        SQLiteDatabase db = this.getReadableDatabase();
        int numRows = (int) DatabaseUtils.queryNumEntries(db,"lock");
        return numRows;
    }
